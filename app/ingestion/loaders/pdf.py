...
def parse_pdf(file_path:str):
    "Parses PDF using Google Cloud Document AI, automatically splits large PDFs into 15-page chunks to bypass synchronous API Limits"
    with logfire.span("Document AI Parsing", filename=file_path):
        try:
            ...
            if total_pages <= MAX_PAGES_PER_REQUEST:
                ...
                logfire.info(f"PDF exceeds {MAX_PAGES_PER_REQUEST} pages, splitting it into chunks")
